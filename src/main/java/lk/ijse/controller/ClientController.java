...
public class ClientController implements Initializable {
    ...
    void appendText(String massage) {
        ...
        massageLbl.setStyle("-fx-background-color:  #70e000;-fx-background-radius:15;-fx-font-size: 18;-fx-font-weight: normal;-fx-text-fill: white;-fx-wrap-text: true;-fx-alignment: center-left;-fx-content-display: left;-fx-padding: 10;-fx-max-width: 350;");
    ...
    private void sendMessage(String text) throws IOException {
        ...
        messageLbl.setStyle("-fx-background-color:  #ffffff;-fx-background-radius:15;-fx-font-size: 18;-fx-font-weight: normal;-fx-text-fill: black;-fx-wrap-text: true;-fx-alignment: center-left;-fx-content-display: left;-fx-padding: 10;-fx-max-width: 350;");
    ...
    public void setImage(byte[] bytes, String sender) {
        ...
        messageLbl.setStyle("-fx-background-color:   #ffffff;-fx-background-radius:15;-fx-font-size: 18;-fx-font-weight: normal;-fx-text-fill: black;-fx-wrap-text: true;-fx-alignment: center;-fx-content-display: left;-fx-padding: 10;-fx-max-width: 350;");
